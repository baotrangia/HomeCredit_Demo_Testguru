...
public class PositiveTest  extends AbstractTestNGCucumberTests  {
    ...
    public static void setup() {
        ...
        ExtentCucumberFormatter.loadConfig(new File("src\\test\\resources\\extentconfig\\extent-config.xml"));

        // User can add the system information as follows
        ExtentCucumberFormatter.addSystemInfo("Browser Name", "Chrome");
        ExtentCucumberFormatter.addSystemInfo("Browser version", "v69.0.3497.100");
